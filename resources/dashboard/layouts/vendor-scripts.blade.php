...
<script src="{{ URL::asset('assets/dashboard/libs/toastify-js') }}"></script>
<script src="{{ URL::asset('assets/dashboard/libs/choices.js/choices.js.min.js') }}"></script>
<script src="{{ URL::asset('assets/dashboard/libs/flatpickr/flatpickr.min.js') }}"></script>
@yield('script')
@yield('script-bottom')
@stack('scripts')
