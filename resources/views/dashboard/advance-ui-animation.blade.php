...
@section('css')
    <link href="{{ URL::asset('/assets/dashboard/libs/aos/aos.min.css') }}" rel="stylesheet">
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-sm-10 col-lg-8">
                                                <div data-aos="fade-up">
                                                    <img src="{{ URL::asset('assets/dashboard/images/mac-img.png') }}" alt="Mac Image"
                                                        class="img-fluid">
                                                </div>
                                            </div>
                                        </div>
...
@endsection
@section('script')
    <script src="{{ URL::asset('/assets/dashboard/libs/aos/aos.min.js') }}"></script>
    <script src="{{ URL::asset('/assets/dashboard/libs/prismjs/prismjs.min.js') }}"></script>
    <script src="{{ URL::asset('/assets/dashboard/js/pages/animation-aos.init.js') }}"></script>
