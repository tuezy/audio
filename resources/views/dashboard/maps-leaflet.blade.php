...
@section('css')
    <link href="{{ URL::asset('assets/dashboard/libs/leaflet/leaflet.min.css') }}" rel="stylesheet" type="text/css" />
...
@section('script')
    ...
    <script src="{{ URL::asset('/assets/dashboard/libs/leaflet/leaflet.min.js') }}"></script>
    <script src="{{ URL::asset('/assets/dashboard/js/pages/leaflet-us-states.js') }}"></script>
    <script src="{{ URL::asset('/assets/dashboard/js/pages/leaflet-map.init.js') }}"></script>
