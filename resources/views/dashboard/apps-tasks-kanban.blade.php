...
@section('css')
    <link href="{{ URL::asset('assets/dashboard/libs/dragula/dragula.min.css') }}" rel="stylesheet">
                                ...
                                <div class="flex-shrink-0">
                                    <div class="avatar-group">
                                        <a href="javascript: void(0);" class="avatar-group-item"
                                            ...
                                            <img src="{{ URL::asset('assets/dashboard/images/users/avatar-9.jpg') }}" alt=""
                                                class="rounded-circle avatar-xxs">
                                        </a>
                                        <a href="javascript: void(0);" class="avatar-group-item"
                                            data-bs-toggle="tooltip" data-bs-trigger="hover"
                                        ...
                                        <li>
                                            <div class="form-check d-flex align-items-center">
                                                ...
                                                <label
                                                    ...
                                                    for="tonya-noble">
                                                    <span class="flex-shrink-0">
                                                        <img src="{{ URL::asset('assets/dashboard/images/users/avatar-10.jpg') }}"
                                                            alt="" class="avatar-xxs rounded-circle" />
                                                    </span>
                                                    <span class="flex-grow-1 ms-2">
                                                        Tonya Noble
...
@endsection
@section('script')
    <script src="{{ URL::asset('assets/dashboard/libs/dragula/dragula.min.js') }}"></script>
    <script src="{{ URL::asset('assets/dashboard/libs/dom-autoscroller/dom-autoscroller.min.js') }}"></script>
    <script src="{{ URL::asset('assets/dashboard/js/pages/tasks-kanban.init.js') }}"></script>
