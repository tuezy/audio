...
@section('script')
    ...
    <script src="{{ URL::asset('/assets/dashboard/libs/isotope-layout/isotope-layout.min.js') }}"></script>
    <script src="{{ URL::asset('/assets/dashboard/js/pages/gallery.init.js') }}"></script>
