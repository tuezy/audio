...
@section('css')
<link rel="stylesheet" href="{{ URL::asset('assets/dashboard/libs/@simonwep/@simonwep.min.css') }}" /> <!-- 'classic' theme -->
...
@endsection
@section('script')
<script src="{{ URL::asset('assets/dashboard/libs/@simonwep/@simonwep.min.js') }}"></script>
<script src="{{ URL::asset('assets/dashboard/js/pages/form-pickers.init.js') }}"></script>
