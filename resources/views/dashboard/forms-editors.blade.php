...
@section('css')
    <link href="{{ URL::asset('assets/dashboard/libs/quill/quill.min.css')}}" rel="stylesheet" type="text/css" />
...
@section('script')
    ...
    <script src="{{ URL::asset('assets/dashboard/libs/quill/quill.min.js') }}"></script>
    <script src="{{ URL::asset('assets/dashboard/js/pages/form-editor.init.js') }}"></script>
