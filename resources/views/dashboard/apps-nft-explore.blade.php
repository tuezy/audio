...
<link href="{{ URL::asset('assets/dashboard/libs/nouislider/nouislider.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
@section('content')
...
<script src="{{ URL::asset('assets/dashboard/js/pages/apps-nft-explore.init.js') }}"></script>
