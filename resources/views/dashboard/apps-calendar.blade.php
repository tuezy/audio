...
@section('css')
    <link href="{{ URL::asset('/assets/dashboard/libs/fullcalendar/fullcalendar.min.css') }}" rel="stylesheet">
@endsection
@section('content')
...
@endsection
@section('script')
    <script src="{{ URL::asset('assets/dashboard/libs/fullcalendar/fullcalendar.min.js') }}"></script>
    <script src="{{ URL::asset('assets/dashboard/js/pages/calendar.init.js') }}"></script>
