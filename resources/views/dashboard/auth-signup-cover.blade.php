...
@section('content')
                                            ...
                                            <div class="position-relative h-100 d-flex flex-column">
                                                <div class="mb-4">
                                                    <a href="index" class="d-block">
                                                        <img src="{{ URL::asset('assets/dashboard/images/logo-light.png') }}" alt="" height="18">
                                                    </a>
                                                </div>
                                                <div class="mt-auto">
                                                    <div class="mb-3">
        ...
        @endsection
        @section('script')
            <script src="{{ URL::asset('assets/dashboard/js/pages/form-validation.init.js') }}"></script>
            <script src="{{ URL::asset('assets/dashboard/js/pages/passowrd-create.init.js') }}"></script>
        @endsection
