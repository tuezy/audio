...
@section('content')
    <div class="position-relative mx-n4 mt-n4">
        <div class="profile-wid-bg profile-setting-img">
            <img src="{{ URL::asset('assets/dashboard/images/profile-bg.jpg') }}" class="profile-wid-img" alt="">
...
@endsection
@section('script')
    <script src="{{ URL::asset('assets/dashboard/js/pages/profile-setting.init.js') }}"></script>
