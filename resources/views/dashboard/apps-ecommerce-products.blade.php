...
@endsection
@section('css')
    <link href="{{ URL::asset('assets/dashboard/libs/nouislider/nouislider.min.css') }}" rel="stylesheet">
...
@section('script')
    ...
    <script src="{{ URL::asset('assets/dashboard/js/pages/ecommerce-product-list.init.js') }}"></script>
