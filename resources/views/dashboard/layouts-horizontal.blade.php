...
@section('css')
    <link href="{{ URL::asset('assets/dashboard/libs/jsvectormap/jsvectormap.min.css') }}" rel="stylesheet">
@endsection
@section('content')
                        ...
                        <div class="card">
                            <div class="card-body p-0">
                                ...
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="px-3">
                                            <img src="{{ URL::asset('assets/dashboard/images/user-illustarator-2.png') }}"
                                                class="img-fluid" alt="">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-6">
                            <div class="text-center">
                                <img src="{{ URL::asset('assets/dashboard/images/illustrator-1.png') }}" class="img-fluid" alt="">
                            </div>
                        </div><!-- end col -->
                    </div><!-- end row -->
                    <div class="mt-3 pt-2">
...
@section('script')
    ...
    <script src="{{ URL::asset('assets/dashboard/libs/jsvectormap/maps/world-merc.js') }}"></script>
    <script src="{{ URL::asset('assets/dashboard/js/pages/dashboard-analytics.init.js') }}"></script>
