                ...
                <div>
                    ...
                    <div class="github-style d-flex align-items-center my-2">
                        <div class="flex-shrink-0 me-2">
                            <img class="avatar-sm rounded" src="{{ URL::asset('assets/dashboard/images/users/avatar-2.jpg') }}" data-hovercard-user-id="634573" alt="" />
                        </div>
...
<script src="{{ URL::asset('assets/dashboard/libs/moment/moment.min.js') }}"></script>
<script src="{{ URL::asset('assets/dashboard/js/pages/apexcharts-area.init.js') }}"></script>
